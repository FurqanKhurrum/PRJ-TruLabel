...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[color:var(--canvas)] px-6 py-12">
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-[color:var(--muted)]">Sign in to your TruLabel account</p>
        </div>
